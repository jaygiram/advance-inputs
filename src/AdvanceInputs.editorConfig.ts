...
// export function getPreview(values: AdvanceInputsPreviewProps, isDarkMode: boolean, version: number[]): PreviewProps {
...
// export function getCustomCaption(values: AdvanceInputsPreviewProps, platform: Platform): string {
